# ZorkBurr Orchestrator Journal — Archive (Episodes 1–34)

> This file contains archived journal entries from episodes 1–34.
> Active journal entries (ep35+) are in `journal.md`.
> This archive is searched by the orchestrator for prior improvement history (3-strikes rule).
